...
def test_rows_to_series_maps_and_skips_none_units():
    ...
    pump_rows = [
        SimpleNamespace(event_timestamp=datetime(2026, 1, 1, 8, 2), units=4.0, is_automated=False),
        SimpleNamespace(event_timestamp=datetime(2026, 1, 1, 8, 3), units=None, is_automated=True),
    ]
