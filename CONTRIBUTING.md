...
**If you push and Push Protection blocks you:** GitHub's error message tells you exactly which secret was detected and where. Three legitimate responses:
1. **It was a real secret you accidentally committed:** rotate the credential immediately at the provider, remove it from the commit (`git commit --amend` or rewrite history), and re-push. Don't bypass.
