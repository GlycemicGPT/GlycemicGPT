...
Three reasons this is the right model for the project:
...
- **Privacy:** your messages go to Anthropic; per their stated terms, subscription traffic is not used for training
...
- **Privacy:** your messages go to OpenAI; subscription policies vary by plan
...
- **Privacy:** API traffic is not used for training, per Anthropic's API terms
...
- **Privacy:** API traffic is not used for training, per OpenAI's API terms
...
| Option | Where your messages go | Used for training? |
|---|---|---|
| Claude subscription | Anthropic's servers | No (per Anthropic terms for Pro/Max) |
| ChatGPT subscription | OpenAI's servers | Plan-dependent |
| Claude API key | Anthropic's servers | No (per Anthropic API terms) |
